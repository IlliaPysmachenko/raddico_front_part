...
export const loadingSlice = createSlice({
    ...
    extraReducers:(builder) => {
        builder
            .addCase(getStudiesThunk.pending, (state) => {state.isLoading = true})
            .addCase(getStudiesThunk.fulfilled, (state) => {state.isLoading = false})
            .addCase(getStudiesThunk.rejected, (state) => {
            state.isError = true;
            state.isLoading = false;
            })
            .addCase(getOptions.pending, (state) => {state.isLoading = true})
            .addCase(getOptions.fulfilled, (state) => {state.isLoading = false})
