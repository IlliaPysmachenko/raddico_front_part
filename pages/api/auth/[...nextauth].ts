...
export default NextAuth({
  providers: [
    {
      ...
      accessTokenUrl: `${process.env.KEYCLOAK_BASE_URL}protocol/openid-connect/token`,
      requestTokenUrl: `${process.env.KEYCLOAK_BASE_URL}protocol/openid-connect/auth`,
      authorizationUrl: `${process.env.KEYCLOAK_BASE_URL}protocol/openid-connect/auth`,
      clientId: process.env.KEYCLOAK_CLIENT_ID,
      clientSecret: process.env.KEYCLOAK_CLIENT_SECRET,
      profileUrl: `${process.env.KEYCLOAK_BASE_URL}protocol/openid-connect/userinfo`,
      profile: (profile) => {
        return {
          ...profile,
          id: profile.sub,
  ...
  callbacks: {
    ...
    async signIn(user, account) {
        return 'http://192.168.2.237:8081';
    },
    /**
